...
public class CalBackListView extends ListView implements AbsListView.OnScrollListener {
    ...
    public CalBackListView(Context context) {
        super(context);
        init();
    }

    public CalBackListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public CalBackListView(Context context, AttributeSet attrs, int defStyle) {
